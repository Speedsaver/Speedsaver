...
Download either a tarball of the latest buildroot release (tested with Buildroot 2022.02.7 LTS using stable kernel 6.0.9 at the time of this writing), and extract it, or git  clone.
